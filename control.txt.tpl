...
basin_gru_shp                   | 06282000.huc12.shp         # basin GRU shapefile, read from 'basin_data_path'/gis/
                                                             # if 'default' entered, set to 'basin_data_path'/gis/gru.shp, extracted from 'fulldom_gru_shpfile'
...
hruNo_field_dtype               | int32               # used to save the hru raster.  Cannot be 'int64'
hruId_fieldname                 | hruId               # field name of the hru ID column, e.g., 10080012010101, 100800120102 ...
huc_fieldname                   | HUCIDXint           # field name of the GRU/HUC attribute in GRU shapefile   
...
## ---- Intermediate files (these could be hardwired names) ---- 
basin_flowlines_shp             | flowlines_prj.shp   # basin stream shapefile path ['basin_data_path/flowlines_prj.shp']; only exists reprojected
...
fulldom_gru_shpfile             | /glade/work/complexity/source_data/west_huc12/WEST.huc12.shp      # large-domain GRU shapefile, if needed
toHuc_fieldname                 | ToHUC               # field name of the downstream GRU/HUC column.
basin_outlet_hucId              | 100800140106        # HUC/GRU where the domain basin outlet is located. 
                                                      #   note: this ID is for 06282000